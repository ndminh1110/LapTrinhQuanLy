...
namespace QuanLyBanHang.Forms
{
    public partial class frmLoaiSanPham : Form
    {
        ...
        //BindingSource bsLoaiSanPham = new BindingSource();
        ...
        private void frmLoaiSanPham_Load(object sender, EventArgs e)
        {
            ...
            //bsLoaiSanPham.DataSource = context.LoaiSanPham.ToList();

            //dataGridView.AutoGenerateColumns = false;
            //dataGridView.DataSource = bsLoaiSanPham;

            //txtTenLoai.DataBindings.Clear();
            //txtTenLoai.DataBindings.Add("Text", bsLoaiSanPham, "TenLoai", true, DataSourceUpdateMode.Never);
            BatTatChucNang(false);
